"""
Django settings for plain_dream_43 project.
...
ROOT_URLCONF = 'plain_dream_43.urls'
...
WSGI_APPLICATION = 'plain_dream_43.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Plain Dream Support <support@plain-dream-43.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_dream_43 API",
    "DESCRIPTION": "API documentation for plain_dream_43 App",
    "VERSION": "v1",
}
